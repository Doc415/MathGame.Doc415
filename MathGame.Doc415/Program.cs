        ...
        for (int i = 0; i < questionsNumber; i++)
        {
            ...
            while (!validInput)
            {
                ...
                if (isInputInt)
                {
                    ...
                    string history = $"Addition\t{difficulty}\t\t{firstNumber}+{secondNumber}=?\t\t{result}\t\t{answered}\t\t{reactionTime.Seconds}sec";
        ...
        for (int i = 0; i < questionsNumber; i++)
        {
            ...
            while (!validInput)
            {
                ...
                if (isInputInt)
                {
                    ...
                    string difficulty = difficult ? "Hard" : "Easy";
                    string answered = answer ? "Correct" : "Wrong";
                    string history = $"Subtraction\t{difficulty}\t\t{firstNumber}+{secondNumber}=?\t\t{result}\t\t{answered}\t\t{reactionTime.Seconds}sec";
                    playerHistory.Add(history);
                    Console.ReadLine();
                }
                else
        ...
        for (int i = 0; i < questionsNumber; i++)
        {
            ...
            while (!validInput)
            {
                ...
                if (isInputInt)
                {
                    ...
                    string difficulty = difficult ? "Hard" : "Easy";
                    string answered = answer ? "Correct" : "Wrong";
                    string history = $"Multiplication\t{difficulty}\t\t{firstNumber}+{secondNumber}=?\t\t{result}\t\t{answered}\t\t{reactionTime.Seconds}sec";
                    playerHistory.Add(history);
                    Console.ReadLine();
                }
                else
        ...
        for (int i = 0; i < questionsNumber; i++)
        {
            ...
            while (!validInput)
            {
                ...
                if (isInputInt)
                {
                    ...
                    string difficulty = difficult ? "Hard" : "Easy";
                    string answered = answer ? "Correct" : "Wrong";
                    string history = $"Division\t{difficulty}\t\t{firstNumber}+{secondNumber}=?\t\t{result}\t\t{answered}\t\t{reactionTime.Seconds}sec";
                    playerHistory.Add(history);
                    Console.ReadLine();
                }
                else
